...
#if defined(KC_ILI7807D_FHDPLUS_DSI_VDO_AUO)
        &kc_ili7807d_fhdplus_dsi_vdo_auo_lcm_drv,
#endif

#if defined(KC_S6E8AA5X01_HDPLUS_DSI_VDO_SAMSUNG)
        &kc_s6e8aa5x01_hdplus_dsi_vdo_samsung_lcm_drv,
#endif

#if defined(KC_FT8201_WUXGA_DSI_VDO_BOE)
        &kc_ft8201_wuxga_dsi_vdo_boe_lcm_drv,
#endif

#if defined(OTM1282C_HD720_DSI_CMD)
        &otm1282c_hd720_dsi_cmd_lcm_drv,
#endif
